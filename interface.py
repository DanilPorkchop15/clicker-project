...
class Ui_BurgerClicker(object):
    ...
    def __init__(self):
        ...
        self.main_buy_3 = 250
        self.main_buy_4 = 500
        self.main_buy_5 = 1000
        self.main_buy_6 = 100
        self.help_buy_1 = 100
        self.help_buy_2 = 500
        self.help_buy_3 = 1000
        self.help_buy_4 = 2500
        self.help_buy_5 = 5000
...
"")
        ...
        self.mainUpgradeBuy_5.setEnabled(False)
        ...
        self.mainUpgradeIcon_13 = QtWidgets.QPushButton(self.helpUpgrade)
        self.mainUpgradeIcon_13.setMinimumSize(QtCore.QSize(50, 0))
        self.mainUpgradeIcon_13.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(-1)
        self.mainUpgradeIcon_13.setFont(font)
        self.mainUpgradeIcon_13.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons8-crying-baby-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mainUpgradeIcon_13.setIcon(icon9)
        self.mainUpgradeIcon_13.setIconSize(QtCore.QSize(40, 40))
        self.mainUpgradeIcon_13.setAutoDefault(False)
        self.mainUpgradeIcon_13.setFlat(True)
        self.mainUpgradeIcon_13.setObjectName("mainUpgradeIcon_13")
        self.horizontalLayout_16.addWidget(self.mainUpgradeIcon_13)
        ...
        self.helUpgradeIcon_14 = QtWidgets.QPushButton(self.helpUpgrade_2)
        self.helUpgradeIcon_14.setMinimumSize(QtCore.QSize(50, 0))
        self.helUpgradeIcon_14.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(-1)
        self.helUpgradeIcon_14.setFont(font)
        self.helUpgradeIcon_14.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons8-student-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.helUpgradeIcon_14.setIcon(icon10)
        self.helUpgradeIcon_14.setIconSize(QtCore.QSize(40, 40))
        self.helUpgradeIcon_14.setFlat(True)
        self.helUpgradeIcon_14.setObjectName("helUpgradeIcon_14")
        self.horizontalLayout_17.addWidget(self.helUpgradeIcon_14)
        ...
        self.mainUpgradeIcon_17 = QtWidgets.QPushButton(self.helpUpgrade_3)
        self.mainUpgradeIcon_17.setMinimumSize(QtCore.QSize(50, 0))
        self.mainUpgradeIcon_17.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(-1)
        self.mainUpgradeIcon_17.setFont(font)
        self.mainUpgradeIcon_17.setText("")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/icons8-worker-60.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mainUpgradeIcon_17.setIcon(icon11)
        self.mainUpgradeIcon_17.setIconSize(QtCore.QSize(40, 40))
        self.mainUpgradeIcon_17.setFlat(True)
        self.mainUpgradeIcon_17.setObjectName("mainUpgradeIcon_17")
        self.horizontalLayout_20.addWidget(self.mainUpgradeIcon_17)
        ...
        self.mainUpgradeIcon_18 = QtWidgets.QPushButton(self.helpUpgrade_4)
        self.mainUpgradeIcon_18.setMinimumSize(QtCore.QSize(50, 0))
        self.mainUpgradeIcon_18.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(-1)
        self.mainUpgradeIcon_18.setFont(font)
        self.mainUpgradeIcon_18.setText("")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/icons8-eating-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mainUpgradeIcon_18.setIcon(icon12)
        self.mainUpgradeIcon_18.setIconSize(QtCore.QSize(40, 40))
        self.mainUpgradeIcon_18.setFlat(True)
        self.mainUpgradeIcon_18.setObjectName("mainUpgradeIcon_18")
        self.horizontalLayout_21.addWidget(self.mainUpgradeIcon_18)
        ...
        self.mainUpgradeIcon_15 = QtWidgets.QPushButton(self.helpUpgrade_5)
        self.mainUpgradeIcon_15.setMinimumSize(QtCore.QSize(50, 0))
        self.mainUpgradeIcon_15.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(-1)
        self.mainUpgradeIcon_15.setFont(font)
        self.mainUpgradeIcon_15.setText("")
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/fat.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mainUpgradeIcon_15.setIcon(icon13)
        self.mainUpgradeIcon_15.setIconSize(QtCore.QSize(40, 40))
        self.mainUpgradeIcon_15.setFlat(True)
        self.mainUpgradeIcon_15.setObjectName("mainUpgradeIcon_15")
        self.horizontalLayout_18.addWidget(self.mainUpgradeIcon_15)
    ...
    def retranslateUi(self, BurgerClicker):
        ...
        self.pushButton.setText(_translate("BurgerClicker", "ВЫКЛЮЧИТЬ"))
    ...
    def  main_upgrade_1(self):
        if self.burger_count >= self.main_buy_1:
            self.burger_count -= self.main_buy_1
            self.main_buy_1 *= 1.2
            self.allUpgrades += 1
            self.allMainUpgrades += 1
            self.click_power += 0.2 * self.main_count_6
            self.main_count_1 += 1
            self.mainUpgradeName.setText(f"Размер рта X {self.main_count_1}")
            self.mainUpgradeBuy.setText(f'{round(self.main_buy_1)} бургеров')
            self.update_count()

    def  main_upgrade_2(self):
        if self.burger_count >= self.main_buy_2:
            self.burger_count -= self.main_buy_2
            self.main_buy_2 *= 1.2
            self.allUpgrades += 1
            self.allMainUpgrades += 1
            self.click_power += 0.5 * self.main_count_6
            self.main_count_2 += 1
            self.mainUpgradeName_2.setText(f"Мощность челючти X {self.main_count_2}")
            self.mainUpgradeBuy_2.setText(f'{round(self.main_buy_2)} бургеров')
            self.update_count()

    def  main_upgrade_3(self):
        if self.burger_count >= self.main_buy_3:
            self.burger_count -= self.main_buy_3
            self.main_buy_3 *= 1.2
            self.allUpgrades += 1
            self.allMainUpgrades += 1
            self.click_power += 1 * self.main_count_6
            self.main_count_3 += 1
            self.mainUpgradeName_3.setText(f"Объем желудка X {self.main_count_3}")
            self.mainUpgradeBuy_3.setText(f'{round(self.main_buy_3)} бургеров')
            self.update_count()

    def  main_upgrade_4(self):
        if self.burger_count >= self.main_buy_4:
            self.burger_count -= self.main_buy_4
            self.main_buy_4 *= 1.2
            self.allUpgrades += 1
            self.allMainUpgrades += 1
            self.click_power += 3 * self.main_count_6
            self.main_count_4 += 1
            self.mainUpgradeName_4.setText(f"Сила кишки X {self.main_count_4}")
            self.mainUpgradeBuy_4.setText(f'{round(self.main_buy_4)} бургеров')
            self.update_count()

    def  main_upgrade_5(self):
        if self.burger_count >= self.main_buy_5:
            self.burger_count -= self.main_buy_5
            self.main_buy_5 *= 1.2
            self.allUpgrades += 1
            self.allMainUpgrades += 1
            self.click_power += 10 * self.main_count_6
            self.main_count_5 += 1
            self.mainUpgradeName_5.setText(f"Аппетит X {self.main_count_5}")
            self.mainUpgradeBuy_5.setText(f'{round(self.main_buy_5)} бургеров')
            self.update_count()
